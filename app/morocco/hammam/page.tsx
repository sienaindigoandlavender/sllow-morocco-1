    ...
    <>
      <div className="bg-background min-h-screen">
        <div className="px-6 md:px-14 pt-20 pb-12 border-b border-foreground/[0.08]">
          ...
          <p className="text-base text-foreground/70 leading-relaxed max-w-xl">The public hammam has been part of Moroccan city life for a thousand years. What follows is the neighbourhood version, not the one your hotel sells.</p>
        </div>
        <div className="px-6 md:px-14 py-16 max-w-3xl space-y-12">
          <div>
            <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">What it actually is</p>
          ...
          <div>
            <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">How it works</p>
          ...
          <div>
            <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">Finding a real one</p>
          ...
          <div className="flex flex-wrap gap-4 pt-4 border-t border-foreground/[0.08]">
            <Link href="/stories/the-hammam" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Read: Inside the hammam →</Link>
