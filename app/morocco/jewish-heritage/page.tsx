  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <div className="px-6 md:px-14 py-16 max-w-3xl space-y-12">
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-6">Where to visit</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">King Mohammed VI and Jewish heritage</p>
        ...
        <div className="flex flex-wrap gap-4 pt-4 border-t border-foreground/[0.08]">
          <Link href="/stories/jewish-heritage-morocco" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Read: Jewish Morocco →</Link>
