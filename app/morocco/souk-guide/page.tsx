  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="px-6 md:px-14 pt-20 pb-12 border-b border-foreground/[0.08]">
        ...
        <p className="text-base text-foreground/70 leading-relaxed max-w-xl">The Marrakech souks cover roughly one square kilometre of narrow streets. The Fes medina has 9,400 of them. Both have an organizing logic that becomes legible once you know what to look for.</p>
      </div>
      <div className="px-6 md:px-14 py-16 max-w-3xl space-y-12">
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">The spatial logic</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">On bargaining</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">What is worth buying</p>
        ...
        <div className="flex flex-wrap gap-4 pt-4 border-t border-foreground/[0.08]">
          <Link href="/stories/moroccan-souk-guide" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Read: The souk guide →</Link>
