  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="px-6 md:px-14 pt-20 pb-12 border-b border-foreground/[0.08]">
        ...
        <p className="text-base text-foreground/70 leading-relaxed max-w-xl">The High Atlas runs 700 kilometres across Morocco. Jebel Toubkal at 4,167 metres is the highest peak in North Africa. Day hikes and multi-day treks depart from villages 90 minutes from Marrakech.</p>
      </div>
      <div className="px-6 md:px-14 py-16 max-w-3xl space-y-12">
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-6">Routes by difficulty</p>
            ...
            {[
              ...
              <div key={item.route} className="border border-foreground/[0.08] p-6">
                <div className="flex items-baseline gap-4 mb-3">
                  ...
                  <span className="text-[10px] tracking-wide text-foreground/60 bg-foreground/[0.04] px-2 py-0.5">{item.time}</span>
                </div>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">Guides</p>
