...
export default function GladiatorMoroccoPage() {
  return (
    <div className="bg-background min-h-screen">
      <ArticleSchema story={{ title: "Where Gladiator Was Filmed in Morocco: Aït Benhaddou's Arena & Gladiator II", slug: "morocco/gladiator-filming-locations", category: "Film" }} />
      <BreadcrumbSchema items={[
        { name: "Morocco", url: "https://www.slowmorocco.com/morocco" },
        { name: "Where Gladiator Was Filmed in Morocco", url: "https://www.slowmorocco.com/morocco/gladiator-filming-locations" },
      ]} />
