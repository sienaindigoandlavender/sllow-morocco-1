  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="px-6 md:px-14 pt-20 pb-12 border-b border-foreground/[0.08]">
        ...
        <p className="text-base text-foreground/70 leading-relaxed max-w-xl">The Amazigh — called Berber in older literature, a term many now reject — are the indigenous inhabitants of North Africa. They predate the Arab conquest by millennia. In Morocco, they are not a minority.</p>
      </div>
      <div className="px-6 md:px-14 py-16 max-w-3xl space-y-12">
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">Who they are</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">Tamazight — the language</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">Where to encounter Amazigh culture</p>
        ...
        <div>
          <p className="text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-4">In the crafts</p>
        ...
        <div className="flex flex-wrap gap-4 pt-4 border-t border-foreground/[0.08]">
          <Link href="/stories/amazigh-identity-map" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Read: Amazigh identity map →</Link>
          <Link href="/stories/carpet-atlas" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Read: Moroccan carpets →</Link>
          <Link href="https://darija.io" className="text-[11px] tracking-[0.15em] uppercase text-foreground/60 hover:text-foreground border-b border-foreground/15 pb-0.5 transition-colors">Darija dictionary →</Link>
        </div>
      </div>
    </div>
  );
