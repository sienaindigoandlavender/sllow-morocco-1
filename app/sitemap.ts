...
const STATIC_PAGES: MetadataRoute.Sitemap = [
  ...
  { url: `${SITE_URL}/morocco/game-of-thrones-filming-locations`, changeFrequency: 'monthly', priority: 0.7 },
  { url: `${SITE_URL}/morocco/gladiator-filming-locations`, changeFrequency: 'monthly', priority: 0.7 },
