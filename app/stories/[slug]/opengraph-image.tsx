...
// OG-specific Cloudinary transform. NOTE: must force f_jpg — the site's normal
// helper uses f_auto (AVIF/WebP), which the OG renderer (Satori) cannot decode.
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    if (story) {
      ...
      kicker = story.category || "Story";
      hero = ogHero(story.hero_image);
    }
  } catch {
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Dark scrim for legibility (stronger at the bottom where text sits) */}
        <div
          style={{
            position: "absolute",
            top: 0,
