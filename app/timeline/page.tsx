...
export default async function HomePage() {
  ...
  try {
    ...
    // Pass the FULL shuffled archive to the homepage (was capped at 17, which froze
    // the same handful in every 3-hour window). The sections below spread across it,
    // so over the day the whole archive rotates through the visible slots.
