          ...
          <section>
            ...
            <div className="border-t border-[#e5e5e5] pt-6">
              <p className="text-[10px] font-mono text-[#aaa] leading-relaxed">
                Compiled by Dance with Lions · dancewithlions.com · Data sourced from World Bank, IEP, Numbeo, HCP Morocco, ANRT, IMF, and official government sources · Last reviewed March 2026 · © Dance with Lions 2026
              </p>
            </div>
          </section>
