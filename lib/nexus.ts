...
const LEGAL_PAGES: Record<string, { title: string; sections: { order: number; title: string; content: string }[] }> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { order: 2, title: "Information We Collect", content: "Information you provide: contact information (name, email), booking information (travel dates, preferences), and communications you send us. Information collected automatically: device information, usage data, and cookies." },
  ...
  "payments": {
    ...
    sections: [
      ...
      { order: 2, title: "Deposit", content: "A deposit of 30% of the total journey price is required to confirm your booking. The deposit is due within 7 days of accepting your proposal. The €300 planning deposit already paid is credited in full against this amount." },
      { order: 3, title: "Balance", content: "The remaining 70% is due no later than 45 days before your arrival date.\n\nFor bookings made within 45 days of travel, full payment (100%) is required at the time of confirmation." },
  ...
  "cancellations-and-refunds": {
    ...
    sections: [
      { order: 1, title: "Cancellation by You", content: "The €300 planning deposit is separate from the sums below and is not refundable, as it pays for design work already carried out for you. The terms here apply to payments made after your booking is confirmed.\n\nBespoke or commissioned arrangements — such as a private ceremony — are governed by their own agreed, non-refundable deposit and terms, set out in the specific proposal and confirmation for that booking, which apply in full and prevail over the schedule below.\n\nWe understand plans change. If you need to cancel your booking, the following applies based on when we receive written notice (email):\n\nMore than 45 days before departure — your deposit is refunded in full, minus any banking or PayPal transaction fees and non-refundable commitments already made with properties. Most hotels refund without issue, though holiday season bookings often carry stricter terms. We will always tell you exactly what can and cannot be recovered.\n\nLess than 45 days before departure — no refund is possible. All commitments are locked at this stage.\n\nThe date we receive your written notice determines which applies." },
