...
const LEGAL_PAGES: Record<string, { title: string; sections: { order: number; title: string; content: string }[] }> = {
  ...
  "booking-conditions": {
    ...
    sections: [
      ...
      { order: 2, title: "The Planning Deposit", content: "Planning begins with a €200 deposit, credited in full to your journey. It holds your dates and opens the design work — the research, the routing, the quiet coordination with our partners that becomes your proposal.\n\nBecause this deposit pays for bespoke work carried out for you, for dates you choose, it is not returned if you decide not to proceed. Under EU consumer law, the fourteen-day right of withdrawal does not apply to travel and leisure services arranged for specific dates (Consumer Rights Directive 2011/83/EU, Article 16(l)); a journey designed for you is such a service. Should you go on to book, the €200 is applied in full against your journey price." },
  ...
  "payments": {
    ...
    sections: [
      ...
      { order: 2, title: "Deposit", content: "A deposit of 30% of the total journey price is required to confirm your booking. The deposit is due within 7 days of accepting your proposal. The €200 planning deposit already paid is credited in full against this amount." },
