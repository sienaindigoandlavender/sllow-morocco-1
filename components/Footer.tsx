          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li><Link href="/stories" className="text-sm text-white/50 hover:text-white/80 transition-colors inline-block py-1.5">All essays</Link></li>
      ...
      <section className="py-2.5 bg-[#080808]">
        <div className="container mx-auto px-8 md:px-16 lg:px-20">
          <p className="text-[9px] tracking-[0.15em] uppercase text-white/50 text-center">
            Powered by <a href="https://www.dancewithlions.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">dancewithlions</a>
          </p>
        </div>
      </section>
