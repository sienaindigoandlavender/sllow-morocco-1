              ...
              return (
                <article key={`${item.type}-${item.slug}`} itemScope itemType="https://schema.org/TouristTrip">
                  <Link href={href} className="group block">
                    ...
                    <span className="block text-[10px] text-[#0a0a0a]/55 tracking-[0.1em] uppercase mb-1" itemProp="duration">
                      {durationLabel}
                    </span>
                    ...
                    {item.description && (
                      <p className="text-[12px] text-[#0a0a0a]/55 leading-relaxed mt-1 mb-0 line-clamp-2" itemProp="description">
                        {item.description}
                      </p>
                    )}
                  </Link>
